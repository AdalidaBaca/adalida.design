...
const KeyTakeaways = forwardRef((_props: Record<never, never>, ref: Ref<HTMLDivElement>): JSX.Element => (
  <div data-aos="fade-up" ref={ref} className="case-study-top-to-bottom querque-key-takeaways project-echo-key-takeaways">
      ...
      <div className="project-echo-results-grid" style={{ marginTop: '0.25em' }}>
        <div className="project-echo-details-card">
          <div className="body-2">
            ...
            feedback. While AI didn&apos;t fully capture the vision, it streamlined early iterations and saved time
            on unused concepts.
          </div>
        </div>
        <div className="project-echo-details-card">
