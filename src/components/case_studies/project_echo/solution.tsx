    ...
    <div data-aos="fade-up" className="case-study-top-to-bottom project-echo-solution-section" ref={ref}>
      <div className="case-study-explanation">
        <div className="project-echo-details-card">
          ...
          <div className="body-2">
            Unlike the original visualization, the new approach allows intersections to be isolated, compared, and
            explored individually. This reduces the need to mentally track overlaps and makes differences between
            populations easier to see and discuss.
          </div>
          <div className="body-2">
            Because the visualization is interactive and data-driven, it can be reused as the dataset evolves, rather
            than recreated as a static image each time.
          </div>
        </div>
      </div>
    </div>
