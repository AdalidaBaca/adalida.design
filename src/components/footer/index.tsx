    ...
    <div className='footer-row footer-bottom'>
      <div className='footer-column'>
        ...
        <div className='footer-links'>
          ...
          <div className='footer-link-row'>
            <a href='https://adalida.notion.site/Adalida-s-B-A-English-Philosophy-13634efdeebd4c83ad11fabc7c4f09c0' className='animated-link'>
          ...
          <a href='https://adalida.notion.site/Adalida-s-B-A-English-Philosophy-13634efdeebd4c83ad11fabc7c4f09c0' className='animated-link footer-link-desktop'>
            Timeline <IconArrowNarrowRight />
          </a>
        </div>
      </div>
